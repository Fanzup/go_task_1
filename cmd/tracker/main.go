...
func main() {
	...
	input := []string{
		...
		"1078,1h30m",
		"7830,2h40m",
		",3456",              // ВЫДАЁТ ОШИБКУ ПО КОНВЕРТАЦИИ ШАГОВ, ИБО ТАМ 0
		"12:40:00, 3456",     // ВЫДАЁТ ОШИБКУ ПО КОНВЕРТАЦИИ ВРЕМЕНИ, НЕВЕРНЫЙ ФОРМАТ
		"something is wrong", // ВЫДАЁТ ОШИБКУ ПО КОНВЕРТАЦИИ ШАГООВ И ВРЕМЕНИ, НЕВЕРНЫЙ ФОРМАТ
	}
